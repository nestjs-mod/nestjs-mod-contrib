...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "apps/example-pg-prisma-pg-flyway/src/prisma-client",
    "example-pg-prisma-pg-flyway/src/prisma-client",
  ]
...
path.join(process.cwd(), "apps/example-pg-prisma-pg-flyway/src/prisma-client/schema.prisma")
