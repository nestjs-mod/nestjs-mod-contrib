...
| ------ | ----------- | ------- | ----------- | ------- | ----- |
|`url`|Connection string for store data (example: redis://:redis_password@localhost:6379)|`obj['url']`, `process.env['EXAMPLE_KEYV_KEYV_USER_URL']`|**optional**|-|```redis://:pass@localhost:6379```|
