...
npm run nx -- g @nx/angular:application --directory=apps/example-minio-angular --name=example-minio-angular --projectNameAndRootFormat=as-provided --strict=true --minimal=true --prefix=app --style=less --ssr=true --viewEncapsulation=None --e2eTestRunner=none --bundler=webpack
```
