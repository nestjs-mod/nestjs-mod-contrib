...
export type GetMigrations_webhookAggregateType<T extends Migrations_webhookAggregateArgs> = {
      [P in keyof T & keyof AggregateMigrations_webhook]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
...
type GetMigrations_webhookGroupByPayload<T extends migrations_webhookGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<Migrations_webhookGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof Migrations_webhookGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
...
export type migrations_webhookCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<migrations_webhookFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface migrations_webhookDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['migrations_webhook'], meta: { name: 'migrations_webhook' } }
  /**
  ...
  count<T extends migrations_webhookCountArgs>(
    ...
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], Migrations_webhookCountAggregateOutputType>
      : number
  >
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, migrations_webhookGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetMigrations_webhookGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
 ...
 */
export type migrations_webhookUpdateManyAndReturnArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * Select specific fields to fetch from the migrations_webhook
   */
 ...
 */
export type migrations_webhookUpsertArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * Select specific fields to fetch from the migrations_webhook
   */
  select?: Prisma.migrations_webhookSelect<ExtArgs> | null
   ...
   */
  create: Prisma.XOR<Prisma.migrations_webhookCreateInput, Prisma.migrations_webhookUncheckedCreateInput>
  /**
   * In case the migrations_webhook was found with the provided `where` argument, update it with this data.
   */
  update: Prisma.XOR<Prisma.migrations_webhookUpdateInput, Prisma.migrations_webhookUncheckedUpdateInput>
}

/**
 * migrations_webhook delete
 */
export type migrations_webhookDeleteArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * Select specific fields to fetch from the migrations_webhook
   */
  select?: Prisma.migrations_webhookSelect<ExtArgs> | null
 ...
 */
export type migrations_webhookDeleteManyArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
 ...
 */
export type migrations_webhookDefaultArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  /**
   * Select specific fields to fetch from the migrations_webhook
   */
  select?: Prisma.migrations_webhookSelect<ExtArgs> | null
