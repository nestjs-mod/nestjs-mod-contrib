...
export interface FilesRestClientConfigurationParameters {
    /**
...
export class FilesRestClientConfiguration {
    /**
     *  @deprecated Since 5.0. Use credentials instead
     */
    apiKeys?: {[ key: string ]: string};
...
constructor({ accessToken, apiKeys, basePath, credentials, encodeParam, encoder, password, username, withCredentials }: FilesRestClientConfigurationParameters = {}) {
        if (apiKeys) {
