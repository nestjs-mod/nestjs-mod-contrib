...
export class WebhookLogGridComponent implements OnInit, OnChanges {
  ...
  showCreateOrUpdateModal(id?: string): void {
    const modal = this.nzModalService.create<WebhookLogFormComponent, WebhookLogFormComponent>({
  ...
  showDeleteModal(id?: string) {
    ...
    this.nzModalService.confirm({
      nzTitle: this.translocoService.translate(`webhook-log.delete-modal.title`, {
        id,
      }),
