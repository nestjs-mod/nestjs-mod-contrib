...
export class BaseService {
    ...
    public configuration: WebhookRestClientConfiguration;
    public encoder: HttpParameterCodec;

    constructor(basePath?: string|string[], configuration?: WebhookRestClientConfiguration) {
        this.configuration = configuration || new WebhookRestClientConfiguration();
